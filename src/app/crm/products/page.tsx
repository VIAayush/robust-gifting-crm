      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link
            ...
            className="inline-flex min-h-10 flex-1 items-center justify-center gap-1.5 rounded-lg bg-[#9C7A33] px-3 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-[#7C6224] hover:text-white sm:flex-none"
          >
        ...
        <form className="flex w-full gap-2">
          ...
          <div className="relative min-w-0 flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 pl-9 pr-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#9C7A33] sm:py-1.5 sm:text-xs"
            />
          </div>
          <button
            type="submit"
