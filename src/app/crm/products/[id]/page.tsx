        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1.5">
            ...
            {product.catalogue_access === 'selected' && (
              <span className="inline-flex items-center gap-1 text-[11px] font-semibold bg-purple-100 text-[#C9A84C] px-2.5 py-0.5 rounded-full">
          ...
          <div className="flex items-center gap-6 mt-4 pt-4 border-t border-gray-100">
            <div>
              ...
              <p className="text-xl font-bold text-[#C9A84C]">{formatCurrency(product.price)}</p>
            </div>
            {showCost && (
            <div>
          ...
          <form action={handleUpdate} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:ring-1 focus:ring-[#C9A84C]"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg font-mono uppercase focus:ring-1 focus:ring-[#C9A84C]"
                />
            ...
            <button
              type="submit"
              className="w-full py-2.5 text-xs font-semibold text-white bg-[#C9A84C] hover:bg-[#A87C2A] hover:text-white rounded-lg shadow-sm transition-colors"
            >
