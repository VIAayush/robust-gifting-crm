        ...
        <form className="flex w-full gap-2">
          ...
          <div className="relative min-w-0 flex-1">
            ...
            <input
              ...
              className="min-h-10 w-full rounded-lg border border-gray-200 bg-gray-50 py-2.5 pl-9 pr-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#C9A84C]"
            />
          </div>
          <button
            type="submit"
            className="inline-flex min-h-10 shrink-0 items-center justify-center rounded-lg bg-[#C9A84C] px-3 text-xs font-semibold text-white hover:bg-[#A87C2A]"
          >
            Search
          </button>
        </form>
                ...
                <div className="flex flex-1 flex-col justify-between space-y-3 p-4 sm:p-5">
                  <div>
                    ...
                    <Link href={`/portal/catalogue/product/${product.id}`}>
                      <h3 className="mt-1 line-clamp-1 text-sm font-semibold text-gray-900 hover:text-[#C9A84C]">{product.name}</h3>
                    </Link>
            ...
            <div className="flex items-center justify-between gap-3 pt-2">
              {currentPage > 1 ? (
                <Link
                  ...
                  className="inline-flex min-h-10 flex-1 items-center justify-center rounded-lg border border-[#E2E8F0] bg-white px-3 text-xs font-semibold text-[#C9A84C] hover:bg-[#F5F7FA] sm:flex-none"
                >
                  Previous
                </Link>
              ) : (
              ...
              {currentPage < totalPages ? (
                <Link
                  href={pageHref(currentPage + 1)}
                  className="inline-flex min-h-10 flex-1 items-center justify-center rounded-lg bg-[#C9A84C] px-3 text-xs font-semibold text-white hover:bg-[#A87C2A] sm:flex-none"
                >
                  Next
                </Link>
              ) : (
